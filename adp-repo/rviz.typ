...
rviz2 : 단순 시각화 위주 담당 (ogre + opengl)
gazebo : 실제 물리 시뮬레이션 연산까지 담당 (물리엔진 ODE, bullet, simbody, DART, etc)
...
- Grid Cells
  ...
  - [messages used] nav_msgs/msg/GridCells
- Image
...
- Wrench
	...
	- [messages used] geometry_msgs/msg/WrenchStamped
- Twist
	- [description] Draws a twist as arrow (linear) and arrow + circle (angular)
	- [messages used] geometry_msgs/msg/TwistStamped
